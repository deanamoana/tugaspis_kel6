...
// Menggunakan PORT_INVENTORY dari .env tunggal
...
app.get('/', (req, res) => {
    res.send(`🚀 Service Inventory (${process.env.DB_NAME || 'mbg'}) sedang berjalan...`);
});
...
sequelize.sync({ alter: true }) 
    .then(() => {
        console.log('--------------------------------------------------');
        console.log(`✅ Database [${process.env.DB_NAME || 'mbg'}] Terkoneksi & Sinkron`);
